            ...
            <div class="col-10">
                <div class="card my-4">
                    <div class="card-header text-center">
                            ...
                            @endif
                            <img class="mx-auto rounded-circle" src="{{ asset($annonce->image_url) }}" alt="Logo de l'entreprise" style="max-width: 150px;">
                            <h3 class="mt-3"> {{$annonce->title}}</h3>
                        
                            <p class="text-right my-auto">
                                <span class="badge p-2 badge-secondary"> {{$annonce->region->name}}</span> A {{$annonce->location}} le {{$annonce->date}}
                            </p>
                    </div>
                    <div class="card-body">
